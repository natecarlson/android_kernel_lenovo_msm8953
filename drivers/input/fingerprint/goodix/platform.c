...
static int gf3206_request_named_gpio(struct gf_dev *gf_dev,const char *label, int *gpio)
{
...
int gf_parse_dts(struct gf_dev* gf_dev)
{
    ...
    /*get reset resource*/
	rc = gf3206_request_named_gpio(gf_dev,"goodix,gpio_reset",&gf_dev->reset_gpio);
    	if(rc) {
    ...
    /*get irq resourece*/
    	rc = gf3206_request_named_gpio(gf_dev,"goodix,gpio_irq",&gf_dev->irq_gpio);
    	if(rc) {
